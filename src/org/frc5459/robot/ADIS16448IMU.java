 ...
 */
public class ADIS16448IMU extends GyroBase implements Gyro, PIDSource, LiveWindowSendable {
  ...
  private static class AcquireTask implements Runnable {
    ...
    public AcquireTask(ADIS16448IMU imu) {
      this.imu = imu;
    }
  ...
  private static class CalculateTask implements Runnable {
    private ADIS16448IMU imu;
    public CalculateTask(ADIS16448IMU imu) {
      this.imu = imu;
    }
   ...
   * Constructor.
   */
  public ADIS16448IMU(Axis yaw_axis, AHRSAlgorithm algorithm) {
    m_yaw_axis = yaw_axis;
   ...
   */
  public ADIS16448IMU(Axis yaw_axis) {
